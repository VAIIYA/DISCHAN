...
export const usePayment = () => {
  ...
  const processPayment = useCallback(async (options: PaymentOptions): Promise<{ success: boolean; transactionId?: string; error?: string }> => {
    ...
    try {
      ...
      if (result.payment.transactionId) {
        ...
        return { success: true, transactionId: result.payment.transactionId };
      }
