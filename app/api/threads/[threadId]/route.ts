...
import { getThreadById } from '@/lib/storage';
...
export async function GET(
  ...
  try {
    ...
    const normalizedThread = {
      ...
      lastReply: (threadData as any).lastActivity ? (typeof (threadData as any).lastActivity === 'string' ? (threadData as any).lastActivity : new Date((threadData as any).lastActivity as any).toISOString()) : undefined,
      ...
      lastActivity: (threadData as any).lastActivity ? (typeof (threadData as any).lastActivity === 'string' ? (threadData as any).lastActivity : new Date((threadData as any).lastActivity as any).toISOString()) : undefined,
      op: {
        ...threadData.op,
